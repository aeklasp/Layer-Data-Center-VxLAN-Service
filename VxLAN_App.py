...
https://inside-openflow.com/2016/07/21/
https://github.com/cmouse/ryu-auto-vxlan/blob/master/fabric.py
...
class user(threading.Thread):   #Thread for user interface, but did not workout 
    def __init__(self):
        threading.Thread.__init__(self)
